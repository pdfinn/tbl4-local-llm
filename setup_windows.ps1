...
Write-Host ""
Write-Host "  After tbl4-n8n is up, in n8n open the Summarise URL"
Write-Host "  workflow and click Publish (top-right button). Then:"
Write-Host ""
Write-Host "   In OpenWebUI: avatar -> Workspace -> Tools tab -> +"
Write-Host "     Paste openwebui-tools/summarise_url.py, save."
Write-Host "   Open a chat, pick llama3.1:latest, toggle the tool on."
Write-Host ""
Write-Host "   MCP path is staged but blocked on an OpenWebUI bug"
Write-Host "   (see TODO.md). Stick to the Python tool path for now."
Write-Host ""
