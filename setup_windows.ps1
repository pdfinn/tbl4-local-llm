...
Write-Host ""
Write-Host "  After tbl4-n8n is up, publish both workflows in n8n"
Write-Host "  (Summarise URL + MCP Tools) via the Publish button,"
Write-Host "  then wire one of the two paths in OpenWebUI:"
Write-Host ""
Write-Host "   Path A (MCP): Admin -> Tools -> Tool Servers -> Add"
Write-Host "     Type: MCP"
Write-Host "     URL:  http://host.docker.internal:5678/webhook/mcpTools/mcp/tools"
Write-Host ""
Write-Host "   Path B (Python Tool): Admin -> Tools -> Create New Tool"
Write-Host "     Paste: openwebui-tools/summarise_url.py"
Write-Host ""
